(function (global, factory) {
    ...
    var Page = {
        ...
        view: function view() {
            return [
                v('header', [
                    v('h1', [
                        v('a[href=/][style=color:white]', {onclick: function onclick(e) {
                            v.routes.go('/');
                            e.preventDefault();
                        }}, 'Valyrian.js'),
                        v('small', ' v1.1.1')
                    ]),
                    v('nav', Page.links.map(function (item) {
                        return v('a', {
                            'data-button': '',
                            href: item.href,
    ...
    var router = v.router();
    router
        .get('/', function () { return v(Pages.Layout, v(Pages.Home)); })
        .get('/getting-started', function () { return v(Pages.Layout, v(Pages.GettingStarted)); })
        .get('/api', function () { return v(Pages.Layout, v(Pages.Api)); })
        .get('/examples', function () { return v(Pages.Layout, v(Pages.Examples)); })
    ;
